...
<html>
  ...
  <div class="container">
    <div>
        <img align="center" alt="Brand" src="admin/assets/img/Logo.png">
      </a>
    </div>
  </div>
</nav>
		...
		<h2 align="center"><b>Login Dulu Bos..</b></h2>
		 <div class="container">
        <div class="row text-center">
         ...
         <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>  Silahkan Login Untuk Akses </strong>  
                            </div>
                            <div class="panel-body">
                                <form method="post" enctype="multipart/form-data"><br/>
                                    ...
                                    Tidak Punya Akun?  <a href="registration.php" >Daftar disini</a>
                                    </form>
                            </div>
