...
<body>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                <br /><br />
                <h2> Pendaftaran Akun User Warung Tani</h2>
               
                <h5>( Registrasikan Akun Anda Untuk Kemudahan Berbelanja )</h5>
                 <br />
            </div>
        </div>
         <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        ...
                        <strong>  Pengguna Baru Silahkan Mendaftarkan Akun Anda </strong>  
                            </div>
