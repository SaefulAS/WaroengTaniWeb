...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
          <div class="navbar-header"><marquee scrollamount="5" behavior="alternate"
              onmouseover="this.stop" onmouseout="this.start" bgcolor="CCCCCC" width="1350" weight="140">
              <h2><b>Halaman Dashboard Khusus Untuk Admin Dari Produk Kelompok Tani<b><h2></marquee>
          </div>
        </nav>   
           <!-- /. NAV TOP  -->
